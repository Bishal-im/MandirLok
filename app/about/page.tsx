        ...
        <div className="relative z-10 h-full flex items-center">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            ...
            <p className="text-white/80 text-base md:text-lg max-w-xl leading-relaxed">
              India's growing platform for authentic temple rituals. Connecting
              millions of devotees with sacred temples across India.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-500 text-sm max-w-xl mx-auto">
              Our core values guide every decision, every partnership and every
              ritual we facilitate.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <p className="text-gray-500 text-sm">Email: help@mandirlok.com</p>
              <p className="text-gray-500 text-sm">WhatsApp: +91 87654 32109</p>
            </div>
            <div>
              <h4 className="font-bold text-gray-900 mb-3 flex items-center gap-2">
