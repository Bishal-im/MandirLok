          ...
          <div className="bg-white border border-[#f0dcc8] rounded-3xl p-8 shadow-card overflow-hidden relative">
            ...
            <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
              <div className="flex items-center gap-6">
                ...
                <div>
                  <h1 className="font-display text-2xl font-bold text-gray-900">{order.poojaId.name}</h1>
              ...
              <div className="text-left md:text-right pt-4 md:pt-0 border-t md:border-t-0 border-[#fdf6ee]">
                ...
                <div className={`inline-flex px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-widest border ${
               ...
               {[
                 ...
                 <div key={idx} className="flex gap-6 relative z-10">
                   <div className={`w-6 h-6 rounded-full flex items-center justify-center border-2 transition-colors duration-500 ${
                     step.completed ? 'bg-[#ff7f0a] border-[#ff7f0a] text-white' : 
